package com.yunya.websocket_server.server;
...
@Slf4j
@Component
// 使用 @ServerEndpoint 注解可以将一个普通的 Java 类标记为 WebSocket 的端点。
// 这意味着这个类可以处理来自客户端的 WebSocket 连接请求，并处理相应的消息。
...
public class WsServer {
     ...
     * CopyOnWriteArrayList 是 Java 中的一种线程安全的列表实现
     */
